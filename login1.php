...
<body>
	...
	<div class="wrap">
		...
		<div  class=" well login">
			...
			<tr>
			<td colspan="2" style="border-top:0px;"> <p>  You have not registered ??</p></td>
			</tr>
			<tr>
			<td style="border-top:0px;"></td>
...
<footer >
		<div style="width:100%;">
			...
			<p class="text-right text-info">	Desinged By : Team CodeMaters</p>
			</div>
		</div>
		</footer>		
	</div>
...
{
if($_SESSION['error']==1)
echo "<script>alert('".$_SESSION['pass']."');document.getElementById(\"wrong\").style.visibility=\"\";</script>";
session_destroy();
}
