				...
				<div >
					<div  style="margin-left:100px; ">
						<table style="padding:5px;">
							<tr> 
								<td > Name &nbsp; </td>
								<td style="font-family:Kristen ITC;"> : Suparno Karmakar</td>
							</tr>
							<tr>
								<td > Profession &nbsp; </td>
								<td style="font-family:Kristen ITC;"> : B.Tech. Computer Science And Engineering ** </td>
							</tr>
							<tr>
								<td > University &nbsp; </td>
								<td style="font-family:Kristen ITC;">Departmenet Of Computer Science And Engineering, University Of Calcutta</td>
							</tr>
						...
						<div style="margin-top:20px;">
							...
							Follow Us On &nbsp;  
							<a href="https://www.facebook.com" target="_blank"><img src="img/f.png"/></a>
						</div>
					</div>
				</div>
			</div>
			...
			<div style="margin-left:195px; float:right;" >
				...
				<div class="about-detail" style="margin-left:110px; margin-top:15px;">
					<table style="padding:5px;">
						<tr> 
							<td> Name &nbsp; </td>
							<td style="font-family:Kristen ITC;"> : Sourjya Mukherjee</td>
						</tr>
						<tr>
							<td> Profession &nbsp; </td>
							<td style="font-family:Kristen ITC;"> : B.Tech. Computer Science And Engineering ** </td>
				...
				<div >
					<div  style="margin-left:100px; ">
						<table style="padding:5px;">
							<tr> 
								<td > Name &nbsp; </td>
								<td style="font-family:Kristen ITC;"> Sumartya Sengupta</td>
							</tr>
							<tr>
								<td > Profession &nbsp; </td>
								<td style="font-family:Kristen ITC;"> : B.Tech. Computer Science And Engineering ** </td>
